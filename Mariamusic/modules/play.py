...
from Mariamusic.tgcalls import calls, queues
from Mariamusic.tgcalls.calls import client as ASS_ACC
from Mariamusic.database.queue import (
    get_active_chats,
    is_active_chat,
    add_active_chat,
    remove_active_chat,
...
from Mariamusic import app
import Mariamusic.tgcalls
from Mariamusic.tgcalls import youtube
from Mariamusic.tgcalls.youtube import download
from Mariamusic.tgcalls import convert as cconvert
...
from Mariamusic.utils.decorators import errors, sudo_users_only
from Mariamusic.utils.administrator import adminsOnly
from Mariamusic.utils.errors import DurationLimitError
from Mariamusic.utils.gets import get_url, get_file_name
from Mariamusic.modules.admins import member_permissions
...
def transcode(filename):
    ffmpeg.input(filename).output(
        "input.raw", format="float32le", acodec="pcm_float32le", ac=2, ar="48k"
